...
//        if (path.contains("/USER-SERVICE/api/auth/login") || path.contains("/actuator/health")|| path.contains("/USER-SERVICE/api/user/add")) {
...
//                            username,
//                            null,
//                            List.of() // tu peux mettre des rôles ici si ton JWT en contient
//                    );
